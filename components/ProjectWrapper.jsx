        ...
        <div className="h-full flex items-center gap-10 justify-center mb-48">
            ...
            <div className="overflow-hidden ">
                <a href={page} className="cursor-view">
                    <img className="sm:w-[367px] sm:h-[297px] md:w-[785px] md:h-[500px] object-cover transition-transform duration-300 ease-in-out hover:scale-105 origin-center" src={src || fallback} />
                </a>
            </div>
        </div>
    );
