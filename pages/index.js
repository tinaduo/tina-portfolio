    ...
    <>
      ...
      <div className='flex flex-row justify-center items-center px-4 sm:px-6 lg:px-8'>
        <div className='flex flex-col justify-start w-full max-w-7xl'>
          <div>
            <div className="flex flex-col justify-start items-start gap-[18px] w-full mb-[80px] sm:mb-[120px] md:mb-[180px] lg:mb-[237px] mt-[80px] sm:mt-[100px] md:mt-[140px] lg:mt-[169px]">
