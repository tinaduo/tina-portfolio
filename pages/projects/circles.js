        ...
        <div className="max-w-6xl mx-auto p-6">
          ...
          <section className="mb-8 flex flex-row justify-between items-center">
            <div className="gap-3.5 flex flex-col justify-start">
              ...
              <h3 className="text-4xl font-medium font-roobert">circles!</h3>
              <p className="w-[450px]">
          ...
          <section className="flex flex-col gap-2">
            ...
            <section className="flex flex-col">
              ...
              <ul className="list-disc pl-5">
                <li>Users need a better photo-sharing experience that's fast, high-quality, and easy to use with efficient storage.</li>
                <li>Users want a centralized space to share photos with close friends, free from the noise of public platforms.</li>
              </ul>
            </section>
